...
<!--	                    	<input class="file_fixed_150px" value="${model.dictName}" name="dictName" id="dictName" <c:if test="${model.isSystemConfig=='1'}">disabled</c:if>/>-->
	                    		<span class="div_form_content_span" style="border-bottom: 1px solid #585757; height: 22px;">${model.dictName}</span>
	                    </div>
	               </li>
	               <li>
	               ...
	               <li style="width: 100%;">
	                    ...
	                    <div class="div_form_content div_form_content2">
	                    	<textarea class="div_text" style="height: 30px;" name="remark" readOnly="true">${model.remark}</textarea>
	                    </div>
	               </li>
	            </ul>
...
//				disabled:flag,
	...
	$('#detailDict_addBtn').click(function(){
		$(window.parent.document).find('#add_ifa,#bgDiv2').css('display','block');
