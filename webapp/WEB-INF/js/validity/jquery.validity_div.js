...
$.validity = {
    ...
    messages:{
        ...
        requireSelect:"#{field} is required.",
        // Format validators:
...
$.fn.extend({
    ...
    // Validate whether the field has a value selected.
    requireSelect:function(msg) {
        return validate(
            this,
            function(obj) {
                if($(obj).val()=='请选择'){
            ...
            msg || $.validity.messages.requireSelect
        );
    },
...
(function($) {
    $.validity.outputs.tooltip = {
        ...
        raise:function($obj, msg) {
			//---------------------------//
			var dialogPos = $('.blank_check_class').offset();
			//---------------------------//
            var pos = $obj.offset();
            pos.left += 5;
           // alert($obj.width() + 18)
            ...
            //给添加特定的id
            var tooltip = $(
                    "<div id=\""+$obj.attr("id")+"require\" class=\"validity-tooltip\">"+msg+"</div>"
                )
                ...
                //.css(pos)
				.css({
					left:pos.left - dialogPos.left,
					top:pos.top - dialogPos.top

				})
				//---------------------------//
                .hide()
                .appendTo(".blank_check_class")
                .fadeIn();
